...
drop policy if exists "Users can create invited staff or bootstrap admin profile" on public.profiles;
create policy "Users can create invited staff or bootstrap admin profile"
