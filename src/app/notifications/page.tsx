...
import { Bell, Package, AlertTriangle, Truck, CheckCircle2, Search, Settings } from "lucide-react";
    ...
    <div className="max-w-4xl mx-auto space-y-6 pb-20 animate-in fade-in slide-in-from-bottom-8 duration-500">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
           ...
           <p className="text-sm font-medium text-slate-500 dark:text-slate-400 dark:text-slate-500 mt-1">Review alerts, updates, and messages from the KT Logistic system.</p>
        </div>
