      ...
      <div className="max-w-4xl w-full px-8 md:px-12 relative z-10">
        ...
        >
          ...
          <div className="flex w-full justify-center sm:w-auto">
            <Link href="/login" className="px-14 py-5 border-2 border-slate-950 bg-slate-950 text-white dark:border-white dark:bg-white dark:text-black font-black uppercase tracking-widest text-[11px] text-center shadow-[8px_8px_0px_0px_rgba(225,29,72,1)] hover:shadow-none hover:translate-x-1 hover:translate-y-1 transition-all">
              Sign In
            </Link>
          </div>
